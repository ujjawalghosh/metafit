  ...
  return (
    <main className="min-h-screen bg-white font-sans text-[#1a1a1a]">
      ...
      <div className="max-w-[800px] mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
        ...
        <section className="mb-12 space-y-4 text-gray-700 leading-relaxed">
          <h2 className="text-2xl md:text-3xl font-bold text-black mb-6 border-b-2 border-black pb-2">Changes to This Privacy Policy</h2>
          <p>
            MetaFit reserves the right to update, modify, or revise this Privacy Policy at any time to reflect changes in our practices, technology, legal requirements, or other factors. We understand that privacy policies should be transparent and accessible, so we are committed to keeping you informed about any material changes.
          </p>
          <p>
          ...
          <ul className="list-disc pl-5 space-y-2 ml-4">
            <li><strong className="text-black">Regular Reviews:</strong> We review our Privacy Policy periodically to ensure it remains current and compliant</li>
          ...
          <p>
            Your continued use of MetaFit's services after any changes to this Privacy Policy constitutes acceptance of the updated policy. If you do not agree with the changes, you may discontinue use of our services and request deletion of your account and personal information.
          </p>
        </section>
        ...
        <section className="mb-12 space-y-4 text-gray-700 leading-relaxed">
          ...
          <p>
            We value your privacy and are committed to addressing your questions, concerns, and requests regarding our privacy practices. Our dedicated privacy team is available to assist you with any privacy-related matters, including exercising your rights under this policy.
          </p>
          <p>
