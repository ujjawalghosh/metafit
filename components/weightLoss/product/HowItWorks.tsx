...
const steps = [
  ...
  },
  {
    ...
    description: "A provider will review your info and prescribe the right GLP-1 treatment for you, if eligible. Get ready for your first dose in two weeks if using insurance, or less than a week if paying cash.",
  ...
  {
    id: 3,
    title: "3. Check your insurance coverage",
    description: "MetaFit checks your insurance to see if GLP-1 coverage is available. If you require prior authorization, MetaFit's insurance concierge fights for coverage and submits all paperwork on your behalf. If you're covered, a prescription is sent to your pharmacy. If not, your provider will suggest alternative FDA-approved cash pay GLP-1 options. This process takes about 2-3 weeks.",
    image: "https://imgctf--assets.ro.co/jj2wf7627pjc/7e1iC0405kglHhubGpeh2L/2f6f2e933960f0a48c98ae827a318185/HIW_Step_3_Module.jpg?fm=webp&q=80&w=1280"
  },
  {
    id: 4,
    title: "4. Start your treatment",
    description: "If paying cash, your medication ships right to your door and you can take your first dose in less than a week. If using insurance, your medication can be picked up at your pharmacy.",
  ...
  {
    id: 5,
    title: "5. Get support to stay on track",
