    ...
    <>
      ...
      <section className="bg-white pb-4">
        <div className="max-w-[1440px] mx-auto">
            <div className="relative h-[400px] md:h-[520px] overflow-hidden group cursor-pointer w-full">
              <Image 
                src="https://imgctf--assets.ro.co/jj2wf7627pjc/65K2lix4ZuaMY6M2ekLLLi/fd8f27687277b6fcd84b52a876437ca2/Frame_1533217643.jpg?fm=webp&q=80&w=1280"
                alt="Serena Williams"
                fill
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-8 md:p-12">
                <h2 className="text-white text-3xl md:text-5xl font-light leading-tight mb-6">
                  serena's on ro.<br/>are you next?
                </h2>
